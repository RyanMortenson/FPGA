...
help:
	...
	@echo '  make synth MOD=demo/pong/project_top'
	@echo '  make implement MOD=demo/pong/project_top'
	@echo '  make clean MOD=demo/pong/project_top'
	@echo '  make passoff_check MOD=demo/pong'
	@echo ''
